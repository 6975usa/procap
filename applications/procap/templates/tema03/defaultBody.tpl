...
<head>
   ...
   <link rel="stylesheet" href="{s $static_url s}/procap/tema03/style.css" type="text/css" media="screen" />
   <!--[if IE 6]><link rel="stylesheet" href="{s $static_url s}/procap/tema03/style.ie6.css" type="text/css" media="screen" /><![endif]-->
   <!--[if IE 7]><link rel="stylesheet" href="{s $static_url s}/procap/tema03/style.ie7.css" type="text/css" media="screen" /><![endif]-->

   <link href='{s $static_url s}/procap/tema03/css/azul.css' rel='stylesheet' type='text/css'>
   ...
   <script src="{s $static_url s}/procap/tema03/js/SpryTabbedPanels.js" type="text/javascript"></script>
   <link href="{s $static_url s}/procap/tema03/css/SpryTabbedPanels.css" rel="stylesheet" type="text/css" />
                    ...
                    {s include file=$leftmenu s}
                        <div class="art-layout-cell art-content">
                          ...
                          <div class="art-post">
                              ...
                              <div class="art-post-body">
                          <div class="art-post-inner art-article">
                                 {s include file=$ultimosAndamentos s}
                          </div>
                          		<div class="cleared"></div>
                              </div>
                          </div>
