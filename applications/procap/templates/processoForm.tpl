        ...
        <form {s $formOptions s} >
            ...
            <div id="voluntarioTabs" class="menu_tabelas" >
                <ul>
                    ...
                    {s if $permitePecas s}
                    <li class="menu_triplo"><a href="#" rel="tab6" >Pe&ccedil;as</a></li>
                        {s /if s}
                </ul>
            </div>
                        ...
                        <td>
                            ...
                            <fieldset class="interno"><legend>Partes</legend>
                                <table class="geral" >
                                    ...
                                    <tr nowrap >
                                        <td align="right" nowrap >Partes contr&aacute;rias</td>
            ...
            <div id="tab5"  class="vt">
                <iframe frameborder="0"  onmouseover="resize('iframe_andamento')" width="774" height="646" id='iframe_andamento'   src="{s $site_url s}/procap/andamento/?pc={s $processoCodigo s}" ></iframe>
            </div>
            {s /if s}
            <!--ANDAMENTOS FIM-->
            ...
            <div id="tab6"  class="vt">
                <iframe frameborder="0" onmouseover="resize('iframe_peca')"  width="774" height="646" id='iframe_peca'   src="{s $site_url s}/procap/peca/?pc={s $processoCodigo s}" ></iframe>
            </div>
            {s /if s}
            </script>
            <!--PE�AS FIM-->
