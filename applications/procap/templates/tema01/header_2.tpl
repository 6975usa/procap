...
<!--   <link rel="stylesheet" href="{s $static_url s}/procap/tema01/style.css" type="text/css" media="screen" />-->
   <!--[if IE 6]><link rel="stylesheet" href="{s $static_url s}/procap/tema01/style.ie6.css" type="text/css" media="screen" /><![endif]-->
   <!--[if IE 7]><link rel="stylesheet" href="{s $static_url s}/procap/tema01/style.ie7.css" type="text/css" media="screen" /><![endif]-->

   <link href='{s $static_url s}/procap/tema01/css/azul.css' rel='stylesheet' type='text/css'>

   <script type="text/javascript" src="{s $static_url s}/procap/tema01/jquery.js"></script>
   <script type="text/javascript" src="{s $static_url s}/procap/tema01/script.js"></script>
