...
class procap_dao_processoadvogadoDAO extends classes_dao_AbstractDAO
{

   public $table = 'procap_processoadvogado';
   ...
   public function getListNames(){
      return  array(
      'processoadvogadoList' => "
            SELECT
               concat( ifnull(p.nome,'') , ifnull(p.nome_fantasia,'') ) as nome
               ,l.processo_id
               ,l.pessoa_id
            from procap_processoadvogado as l
