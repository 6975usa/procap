...
class procap_dao_agendaDAO extends classes_dao_AbstractDAO {
    ...
    public function getListNames() {
        ...
        $where.=" and ( a.inicio_data is not null and a.termino_data is not null and a.conclusao_data is null )";
    ...
    function getPessoaTipo($pessoaId) {
        ...
        if ($res->numRows() < 1) {
            ...
            throw new Exception('H� mais de um advogado com o mesmo Nome de Login');
        } else {
