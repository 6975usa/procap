...
class procap_view_orgaojudicialView extends classes_smarty_abstractSystemSmarty  {
   ...
   function execute(){
      ...
      $this->assign('_form',APP_ROOT.'/procap/templates/orgaojudicialForm.tpl' );


      $this->display(APP_ROOT.'/procap/templates/'.DEFAULT_THEME.'/defaultBody.tpl');


      $this->display(APP_ROOT.'/procap/templates/orgaojudicial.tpl');
