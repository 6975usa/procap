...
class procap_view_processoadvogadoView extends classes_smarty_abstractSystemSmarty  {
   ...
   function execute(){
      ...
      $this->assign('_form',APP_ROOT.'/procap/templates/processoadvogadoForm.tpl' );
