...
class procap_model_structure_tipoandamentoListStructure extends classes_model_structure_AbstractStructure
{
   ...
   function setUpStructure(){
      ...
      $this->listName = 'tipoandamentoList' ;
      $this->listTemplate = APPLICATIONS_ROOT.'/procap/templates/'.DEFAULT_THEME.'/defaultList.tpl' ;

      $this->dao = 'procap_dao_tipoandamentoDAO';

      $this->listTitle = 'Tipos de Andamento';
