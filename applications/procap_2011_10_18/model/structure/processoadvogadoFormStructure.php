...
class procap_model_structure_processoadvogadoFormStructure extends classes_model_structure_AbstractStructure
{
   ...
   function setUpStructure(){
      ...
      $this->formName = 'processoadvogadoForm' ;

      $this->table = 'procap_processoadvogado';
