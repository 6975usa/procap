...
class procap_dao_comarcaDAO extends classes_dao_AbstractDAO
{

   public $table = 'procap_comarca';
   ...
   function getComarcas(){
      $sql = "select distinct id as codigo  , descricao from procap_comarca order by descricao  ";
