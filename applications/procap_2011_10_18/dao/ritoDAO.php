...
class procap_dao_ritoDAO extends classes_dao_AbstractDAO
{

   public $table = 'procap_rito';
   ...
   function getRitos(){
      $sql = "select distinct id as codigo  , descricao from procap_rito order by descricao  ";
