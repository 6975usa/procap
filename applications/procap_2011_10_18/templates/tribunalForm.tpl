   ...
   {s /foreach s}
      ...
      <fieldset class="interno"><legend>Endereço</legend>
         <table class="geral">
         	...
         	<tr nowrap ><td nowrap >{s $cidade_id_label s}{s $cidade_id_required s} </td><td>{s $cidade_id_html s}{s $cidade_id_error s}<span class="error">{s $formErrorMessages.cidade_id s}</span></td></tr>
