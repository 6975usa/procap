...
class pesquisa_view_aprenderView extends classes_smarty_abstractSystemSmarty  {
   ...
   function execute(){
      ...
      //$this->display(BASE_ROOT.'/pesquisa/templates/aprender.tpl');

      $this->assign('header',APP_ROOT.'/pesquisa/templates/header.tpl' );
      $this->display(APP_ROOT.'/pesquisa/templates/aprender.tpl');
