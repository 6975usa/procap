...
class admin_config_DatabaseConfiguration extends classes_dao_AbstractDatabaseConfiguration   {
   ...
   public static function getRemoteConnInfo($dao){
      switch ($dao) {
         ...
         default:
            //require_once(BASE_ROOT.'/db/DbConfig.php');
            //$DbString = new DbString();
            //$connString = $DbString->getConnString();
            return
            array(
            'phptype'=>'mysql',
            'username'=>'procap',
