...
class procap_model_structure_advogadoFormStructure extends classes_model_structure_AbstractStructure
{
...
/*
      ...
      'qf_label'=>'Tratamento',
      'qf_type'  => 'select',
      'qf_vals' => array('dao'=>'procap_dao_clienteDAO','functionName'=>'getTratamentos'),
      ),*/
      ...
      'qf_type'  => 'select',
      'qf_vals' => array('dao'=>'procap_dao_clienteDAO','functionName'=>'getEstadosCivis'),
      ),
      ...
      'form'=>true,
      'validate'=>true,
      'qf_label'=>'Nome de Login',
      'qf_type'  => 'select',
      'qf_vals' => array('dao'=>'procap_dao_advogadoDAO','functionName'=>'getLoginNames'),
      'qf_rules' =>
         array(
         'required' => 'não pode ser vazio',
