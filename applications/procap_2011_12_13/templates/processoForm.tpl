...
<div class="form">
   ...
   <div align="center" id="form" >
      ...
      <div id="tab5"  class="vt">
         <iframe frameborder="0"    onLoad="resize('iframe_andamento');"  width="774" height="500"  id='iframe_andamento'   src="{s $site_url s}/procap/andamento/?pc={s $processoCodigo s}" ></iframe>
      </div>
      {s /if s}
      <!--ANDAMENTOS FIM-->
