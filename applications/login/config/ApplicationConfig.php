...
class login_config_ApplicationConfig{
   ...
   public function setActions(){
      $this->actions = array(
         'default' => 'login_controller_loginController',
         'logout' => 'login_controller_logoutController',
         'office' => 'login_controller_officeController',
      );
   }
