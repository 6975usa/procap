...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=ISO-8859-1" />
   ...
   <link rel="stylesheet" href="{s $static_url s}/login/style.css" type="text/css" media="screen" />
   <!--[if IE 6]><link rel="stylesheet" href="{s $static_url s}/login/style.ie6.css" type="text/css" media="screen" /><![endif]-->
   <!--[if IE 7]><link rel="stylesheet" href="{s $static_url s}/login/style.ie7.css" type="text/css" media="screen" /><![endif]-->
   <script type="text/javascript" src="{s $static_url s}/login/jquery.js"></script>
   <script type="text/javascript" src="{s $static_url s}/login/script.js"></script>


   <meta name="description" content="Projeto" />
   <meta name="author" content="Anselmo S Ribeiro" />
   <link href='{s $static_url s}/login/css/azul.css' rel='stylesheet' type='text/css'>
