...
class classes_dao_observerDAO
{
   ...
   function logError($user_id,$error_id,$query){
      ...
      $res = $this->conn->Execute($sql,array($id,$date,$user_id,$error_id,$query,$url,$appName,$actionName,$ip));
