    ...
    function getValidationScript(&$element, $elementName, $ruleData)
    {
        ...
        if (!isset($ruleData['howmany'])) {
            $js = $jsValue . "\n" . $jsPrefix .
                  ...
                  "    frm.elements['{$jsField}'].className = 'error'  ;\n" .
                  "    frm.elements['{$jsField}'].focus()  ;\n" .
                  "    alert('{$ruleData['message']}') ; \n" .
                  "    return false; \n" .
...
/*                  "    _qfMsg = _qfMsg + '\\n - {$ruleData['message']}';\n" .*/
                  ...
                  "  }\n".
                  "  else{\n".
                  "     if( frm.elements['{$jsField}'].className == 'error' ){\n".
                  "        frm.elements['{$jsField}'].className = '' ;\n".
                  "     }\n".
                  "  }\n";
        } else {
            $js = $jsValue . "\n" . $jsPrefix .
