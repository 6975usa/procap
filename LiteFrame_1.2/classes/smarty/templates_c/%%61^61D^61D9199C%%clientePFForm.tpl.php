<?php /* Smarty version 2.6.19, created on 2011-12-13 15:22:09
         compiled from /var/www/procap/LiteFrame_1.2/config/custom/../../../../procap/applications/procap/templates/clientePFForm.tpl */ ?>
<!-- ###########    FORMULARIO COMECO  ################ -->
            ...
            <center>
              <h3>Cliente</h3></center>
               <fieldset class="interno" id="pessoafisica_fs"  ><legend>Pessoa F&iacute;sica</legend>
                 <table class="geral" >
                   <tr >
                     <td nowrap="nowrap" ><strong><?php echo $this->_tpl_vars['nome_label']; ?>
* </strong></td>
                     <td colspan="3"><?php echo $this->_tpl_vars['nome_html']; ?>
...
<span class="error"><?php echo $this->_tpl_vars['formErrorMessages']['nome']; ?>
                   ...
                   <tr >
                     ...
                     <td><?php echo $this->_tpl_vars['sexo_html']; ?>
...
<span class="error"><?php echo $this->_tpl_vars['formErrorMessages']['nascimento']; ?>
                   ...
                   <tr >
                     <td nowrap="nowrap" ><strong><?php echo $this->_tpl_vars['estadocivil_id_label']; ?>
<?php echo $this->_tpl_vars['estadocivil_id_required']; ?>
 </strong></td>
                     <td width="250"><?php echo $this->_tpl_vars['estadocivil_id_html']; ?>
...
<span class="error"><?php echo $this->_tpl_vars['formErrorMessages']['identidade']; ?>
                   ...
                   <tr >
                     <td nowrap="nowrap" ><strong><?php echo $this->_tpl_vars['nacionalidade_label']; ?>
<?php echo $this->_tpl_vars['nacionalidade_required']; ?>
 </strong></td>
                     <td width="250"><?php echo $this->_tpl_vars['nacionalidade_html']; ?>
...
<span class="error"><?php echo $this->_tpl_vars['formErrorMessages']['cpf']; ?>
                   ...
                   <tr >
                     <td nowrap="nowrap" ><strong><?php echo $this->_tpl_vars['profissao_label']; ?>
<?php echo $this->_tpl_vars['profissao_required']; ?>
 </strong></td>
                     <td width="250"><?php echo $this->_tpl_vars['profissao_html']; ?>
