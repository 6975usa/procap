<?php /* Smarty version 2.6.19, created on 2011-12-13 15:25:05
         compiled from /var/www/procap/LiteFrame_1.2/config/custom/../../../../procap/applications/procap/templates/pecaList.tpl */ ?>
<!-- ###########   LISTAS INICIO  ################ -->
...
')" >
                     ...
                     <td align="left"><?php echo $this->_tpl_vars['dados']['andamento']; ?>
</TD>
                     <td align="left"><?php echo $this->_tpl_vars['dados']['inicio']; ?>
</TD>
                     <td align="left"><?php echo $this->_tpl_vars['dados']['termino']; ?>
</TD>
                     <td align="left">&nbsp;
                        <?php if ($this->_tpl_vars['dados']['arquivo']): ?>
                           <a target="_blank" href="<?php echo $this->_tpl_vars['dados']['arquivo']; ?>
"><img src="<?php echo $this->_tpl_vars['static_url']; ?>
/procap/tema01/images/task_f2.png" border="0" ></a>
                        <?php endif; ?>
                     </TD>
                  </tr>
                  <?php endforeach; endif; unset($_from); ?>
