 ...
 */
     ...
     * @param string $compile_id
     */
    function toHtml($resource_name)
    {
        $this->fetch($resource_name, null, null, true,true);
    }
     ...
     */
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false, $returnHtml=false)
    {
