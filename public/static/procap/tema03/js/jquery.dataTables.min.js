...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Exibir _MENU_ registros",sZeroRecords:"Valor não encontrado",sEmptyTable:"Nenhum Registro",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 to 0 of 0 registros",sInfoFiltered:"(filtrado de _MAX_ registros no total)",sInfoPostFix:"",sSearch:"Filtrar:",sUrl:"",oPaginate:{sFirst:"<<",sPrevious:"<",sNext:">",sLast:">>"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
